    ...
    *,
    ...
    async with SessionLocal() as session:
        ...
        for opportunity, account_name in rows:
            ...
            score_differs = (
                scored.score != before
                or scored.needs_review != opportunity.needs_review
                or type_stale
            )
            ...
            if score_differs:
                ...
                if not dry_run:
                    ...
                    # signal_type moves with the score: all three come out of
                    # the same scoring pass, and a fresh score beside a stale
                    # label is the inconsistency this script exists to remove.
                    if type_stale:
